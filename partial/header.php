...
<head>
    ...
    <meta name="description" content="DART Bus Schedules - Accessible Format - Effective February 14, 2016">
    <meta name="author" content="Praveen Kumar">
    <meta name="dev" content="fon">
                    ...
                    <form class="navbar-form navbar-left" method="get" action="index.php" role="search">
                        <div class="input-group input-group-md">
                            ...
                            <span class="input-group-addon" id="search-span">
                                <button class="glyphicon glyphicon-search btn btn-danger"></button>
                            </span>
                        </div>
                    </form>
